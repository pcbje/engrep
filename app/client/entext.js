...
modules.service('search', function($rootScope, $sce, $sanitize, $http, $location, api) {
  var timeout;
  var e;
  var intro = "Hi there!\n\nThis is a simple demo application of an algorithm for multi-pattern approximate search. It lets you search full text for patterns in a defined dictionary, like names and organiztions, with errors (insert, edit, delete and transpose, you know, splling mistakes).\n\nFor example, Vasili Pushkin may be a different transliteration of Vasily Pushkin the poet, and Ryen Renolds may just be lazy writing. Think of it as a combination of Aho-Corasick and Levenshtein automata, although that's not quite how it works. "
     ...
     + "Nothing you send will be stored on disk, and inactive dictionaries will be forgotten. However, we do gather some metrics to measure performance.\n\nQuestions or comments? Get in touch! <a href=\"mailto:paper@pcbje.com\">paper@pcbje.com</a>\n\n";
